...
const items = [
    {
        key: '1',
        label: <p className="text-orange-600 text-sm p-2 font-medium">Ask Doubts</p>,
        children: <AskDoubt />,
    },
    {
        key: '2',
        label: <p className="text-orange-600 text-sm p-2 font-medium">Doubts History</p>,
        children: <DoubtHistory />,
    }
];
        ...
        <div className="h-[100vh] bg-gray-900">
            ...
            <div className="flex gap-[90px]">
                <div className="flex flex-col gap-10 h-[540px] w-[230px] ml-4 mt-3 rounded-xl text-lg font-bold bg-orange-600">
                    ...
                    <p className="mt-3 ml-3 border-l-2 border-blue-600 rounded-sm cursor-pointer bg-gray-900 hover:scale-110 duration-300 text-orange-600"><i className="text-3xl p-1  ri-book-read-line"></i>Doubts</p>
                ...
                <div className="border-4 border-orange-600 w-[1180px] h-[540px] mt-3 rounded-xl">
                    <Tabs defaultActiveKey="1" items={items} className="text-orange-600" />
                </div>
            </div>
