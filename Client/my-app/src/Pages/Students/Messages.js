        ...
        <div className="h-[100vh] bg-gray-900">
            ...
            <div className="flex gap-[90px]">
                <div className="flex flex-col gap-10 h-[540px] w-[230px] ml-4 mt-3 rounded-xl text-lg font-bold bg-orange-600">
                    ...
                    <p className="mt-3 ml-3 border-l-2 border-blue-600 rounded-sm cursor-pointer bg-gray-900 hover:scale-110 duration-300 text-orange-600"><i className="text-3xl p-1  ri-chat-1-line"></i>Messages</p>
                </div>
